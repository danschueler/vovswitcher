index.php is the file needed to run the VoV Switcher application.  It runs on top of a LAMP stack on a Raspberry Pi.  It is used to switch audio sources from multiple studios on an intranet.
